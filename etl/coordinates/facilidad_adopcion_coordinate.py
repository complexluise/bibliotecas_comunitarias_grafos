...
class PorcentajeColeccionCatalogadaCoordinate(AnalysisCoordinate):
    def __init__(self, driver, df_encuestas):
        super().__init__(
            driver,
            df_encuestas,
            name="Porcentaje de colección catalogada",
...
class CapacidadTecnicaPersonalCoordinate(AnalysisCoordinate):
    def __init__(self, driver, df_encuestas):
        super().__init__(
            driver,
            df_encuestas,
            name="Capacidad técnica del personal",
...
class SobrecargaAdministrativaCoordinate(AnalysisCoordinate):
    def __init__(self, driver, df_encuestas):
        super().__init__(
            driver,
            df_encuestas,
            name="Sobrecarga administrativa",
...
class TiposColeccionCoordinate(AnalysisCoordinate):
    def __init__(self, driver):
        super().__init__(
            driver,
            name="Tipos de colección",
            description="Variedad de tipos de colección disponibles",
        )
